...
The stop codons specify the end of a protein coding gene. 
...
The code checks for the DNA sequence length to determine if proper codons can be formed. If not it gives warning and stop the program.
